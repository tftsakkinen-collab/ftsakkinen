...
export default function VideoLibraryPage() {
  ...
  const filteredVideos = videos.filter((v) => {
    const matchesCat =
      selectedCategory === "kaikki" || v.categoryId === selectedCategory;
    const matchesSearch =
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-4xl sm:text-6xl font-display text-white tracking-wide">
            SELAUTUVA <span className="text-[#00AEEF]">KUNTOUTUSKIRJASTO</span>
          </h1>

          <p className="text-gray-300 text-base sm:text-lg">
            Valitse kehonosa tai oirealue löytääksesi fysioterapeutti Janne Säkkisen täsmälliset ohjevideot ja liikemateriaalit.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="max-w-md mx-auto relative">
            ...
            <input
              type="text"
              placeholder="Etsi videota hakusanalla (esim. iskias, polvi)..."
              value={searchQuery}
