...
import { PlayCircle, Search, Sparkles, BookOpen, Layers } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4">
          ...
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
            Tutustu OMT-fysioterapeutti Janne Säkkisen kaikkivaan 68 julkaistuun fysioterapiavideoon ja AEO-optimotuihin blogiartikkeleihin. Videot on jaoteltu kolmeen pääosa-alueeseen.
          </p>
        </div>
