      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-4">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#00AEEF] bg-white p-1 flex items-center justify-center shadow-[0_0_10px_rgba(0,174,239,0.5)]">
        ...
        <div className="mt-8 pt-6 border-t border-[#0C66B4]/20 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400 gap-4">
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#000d21] border border-[#00AEEF]/40 text-[#00AEEF] text-[11px] font-medium shadow-glow">
            ...
            <span className="text-gray-300">Rekisteröity OMT-Fysioterapeutti (SOMTY)</span>
          </div>

          <div className="flex flex-wrap items-center gap-4">
            <VisitorCounter siteKey="ftsakkinen_com" label="Sivuston kävijämäärä" />
            <span className="text-gray-400 font-medium">Y-tunnus: <span className="text-white font-semibold">3505813-7</span></span>
            <p className="text-gray-500">© {new Date().getFullYear()} {SITE_CONFIG.companyName}. Kaikki oikeudet pidätetään.</p>
          </div>
        </div>
      </div>
    </footer>
